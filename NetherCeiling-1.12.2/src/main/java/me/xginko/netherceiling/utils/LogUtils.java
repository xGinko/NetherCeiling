...
public class LogUtils {
    ...
    public static void materialNotRecognized(Level logLevel, String moduleName, String material) {
        moduleLog(logLevel, moduleName, "Material '" + material + "' not recognized. Please use the correct enums from https://helpch.at/docs/1.12.2/org/bukkit/Material.html");
    }

    public static void entityTypeNotRecognized(Level logLevel, String moduleName, String entityType) {
        moduleLog(logLevel, moduleName, "EntityType '" + entityType + "' not recognized. Please use the correct enums from https://helpch.at/docs/1.12.2/org/bukkit/entity/EntityType.html");
    }

    public static void enchantmentNotRecognized(Level logLevel, String moduleName, String enchantment) {
        moduleLog(logLevel, moduleName, "Enchantment '" + enchantment + "' not recognized. Please use the correct enums from https://helpch.at/docs/1.12.2/org/bukkit/enchantments/Enchantment.html");
    }
    ...
    public static void potionEffectNotRecognized(Level logLevel, String moduleName, String effectType) {
        moduleLog(logLevel, moduleName, "PotionEffectType '" + effectType + "' not recognized. Please use the correct enums from https://helpch.at/docs/1.12.2/index.html?org/bukkit/potion/PotionEffectType.html");
    }
}